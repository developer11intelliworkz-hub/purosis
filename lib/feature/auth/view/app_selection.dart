    ...
    return Scaffold(body: Column(
      ...
      children: [
        ...
        Container(
          ...
          decoration: BoxDecoration(color: Color(0xFF1D2D59),shape: BoxShape.circle),
          alignment: Alignment.center,
          child: Text("Pure water plays\nvital role in\nmaintaining our\ndaily lifestyle.\nHygiene and\nHealth!",style: TextStyle(color: Colors.white,fontSize: 18),textAlign: TextAlign.center,),
        ),
        Expanded(
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.center,
