        ...
        child: Column(children: [
          SizedBox(
            ...
            child: GridView(
              ...
              gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(crossAxisCount: 2,crossAxisSpacing: 10,mainAxisSpacing: 10),children: [
              Card(
                child:Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      AppText(text: "Post",fontWeight: FontWeight.w700,fontSize: 20,),
                      SizedBox(height: 40,),
                      Container(
                        height: 50,
                        width: 50,
              ...
              Card(
                child:Padding(
                  ...
                  child: Column(
                    ...
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      AppText(text: "Brochure",fontWeight: FontWeight.w700,fontSize: 20,),
                      SizedBox(height: 40,),
                      Container(
                        height: 50,
                        width: 50,
              ...
              Card(
                child:Padding(
                  ...
                  child: Column(
                    ...
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      AppText(text: "Video",fontWeight: FontWeight.w700,fontSize: 20,),
                      SizedBox(height: 40,),
                      Container(
                        height: 50,
                        width: 50,
              ...
              Card(
                child:Padding(
                  ...
                  child: Column(
                    ...
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      AppText(text: "Reel",fontWeight: FontWeight.w700,fontSize: 20,),
                      SizedBox(height: 40,),
                      Container(
                        height: 50,
                        width: 50,
              ...
              Card(
                child:Padding(
                  ...
                  child: Column(
                    ...
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      AppText(text: "Leaflet",fontWeight: FontWeight.w700,fontSize: 20,),
                      SizedBox(height: 40,),
                      Container(
                        height: 50,
                        width: 50,
