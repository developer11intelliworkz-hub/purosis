...
class CustomizePostDistributor extends StatefulWidget {
  const CustomizePostDistributor({super.key});

  @override
  State<CustomizePostDistributor> createState() =>
      _CustomizePostDistributorState();
}

class _CustomizePostDistributorState extends State<CustomizePostDistributor> {
