...
class CustomizePostPreviewDistributor extends StatefulWidget {
  const CustomizePostPreviewDistributor({super.key});

  @override
  State<CustomizePostPreviewDistributor> createState() =>
      _CustomizePostPreviewDistributorState();
}

class _CustomizePostPreviewDistributorState
