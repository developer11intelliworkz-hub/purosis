              ...
              child:Padding(
                ...
                child: Column(
                  children: [
                    Expanded(
                      ...
                      return Padding(
                        ...
                        child: Column(
                          ...
                          Row(
                            children: [
                            Expanded(child: AppText(text: "PuroAqua Water Purifiers",fontWeight: FontWeight.w700,)),
                    ...
                    Row(
                      children: [
                        AppText(text: "Total",fontWeight: FontWeight.w700,color: Color(0xFF0067B1),),
                        Spacer(),
            ...
            child: ListView.separated(itemBuilder: (context, index) {
              return Card(child: Padding(
                ...
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    AppText(text: "Billing Address",fontWeight: FontWeight.w700,color: Color(0xFF0067B1)),
                    Divider(),
                    SizedBox(height: 5,),
