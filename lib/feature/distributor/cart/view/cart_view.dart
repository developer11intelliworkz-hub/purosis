        ...
        children: [
          EasyStepper(
            ...
            steps: const [
              ...
              EasyStep(icon: Icon(Icons.circle_outlined), title: 'Dealer Info'),
              EasyStep(icon: Icon(Icons.circle_outlined), title: 'Transport'),
              EasyStep(icon: Icon(Icons.circle_outlined), title: 'Review'),
            ],
          ),
          Expanded(
