    ...
    return Scaffold(appBar: AppBar(),body: SingleChildScrollView(
      child: Column(
            ...
            child: Row(children: [
              ...
              Column(
                ...
                Container(
                  ...
                  child: Row(children: [Icon(Icons.upload,color: Colors.grey),AppText(text: "Upload Logo",color: Colors.grey,)],),),
                SizedBox(height: 3,),
                AppText(text: "Your logo will appear on marketing\nmaterials you customize",color: Colors.grey,),
              ],)
            ],),
          ),
        ),
        Padding(
          ...
          child: AppText(text: "Basic Information",fontWeight: FontWeight.w600,color: Colors.blue,),
        ),
        Card(
          margin: EdgeInsets.all(10),
          child: Padding(
        ...
        Padding(
            padding: const EdgeInsets.only(left: 8.0),
            child: AppText(text: "Contact Information",fontWeight: FontWeight.w600,color: Colors.blue,),
          ),
        Card(
            margin: EdgeInsets.all(10),
            child: Padding(
        ...
        Padding(
            padding: const EdgeInsets.only(left: 8.0),
            child: AppText(text: "Addresses",fontWeight: FontWeight.w600,color: Colors.blue,),
          ),
        Card(
            margin: EdgeInsets.all(10),
            child: Padding(
